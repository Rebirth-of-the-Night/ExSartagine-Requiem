...
public class ExSartagineBlocks {
	...
	public static void load(IForgeRegistry<Block> registry){
		...
		pot = new BlockPot();
		range = new BlockRange(() -> ConfigHandler.range_requires_ignition,3,false).setRegistryName("range").setTranslationKey(ExSartagine.MODID + ".range");
		...
		hearth = new BlockRange(() -> ConfigHandler.hearth_requires_ignition,1,true).setRegistryName("hearth").setTranslationKey(ExSartagine.MODID + ".hearth");
